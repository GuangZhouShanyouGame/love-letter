  ...
  async mounted() {
    ...
    const loader = new resLoader({
      resources: [
        ...
        conFig.host + '/static/img/btn_go_letter.png',
        conFig.host + '/static/img/btn_my_letter.png',
        // conFig.host + '/static/img/coupon.png',
        conFig.host + '/static/img/flower_heart.png',
        // conFig.host + '/static/img/icon_close.png',
        conFig.host + '/static/img/icon_letter.gif',
        ...
        // conFig.host + '/static/img/share.png',
        conFig.host + '/static/img/shouye_bg.jpg',
        // conFig.host + '/static/img/shouye_bg_01.png',
        conFig.host + '/static/img/shouye_collect.png',
        ...
        conFig.host + '/static/img/shoye_bg_01.jpg',
        // conFig.host + '/static/img/text_new_letter.png',
        ...
        conFig.host + '/static/img/ticket-zy.png',
        conFig.host + '/static/img/ticket-hd.png',
        conFig.host + '/static/img/ticket-bn.png',
        conFig.host + '/static/img/bg-rule.png',
